...
const ProductModal: React.FC<{ product?: Product, page: number }> = ({ product = null, page }) => {
    ...
    // icons
    const { FaRegTrashAlt, MdOutlineCancel, IoIosAddCircleOutline, HiOutlineXMark } = icons
    ...
    const handleProductAction = async (e: FormEvent<HTMLFormElement>) => {
        ...
        // temporary test
        tempProduct['productCodes'] = [{ code: tempProduct['productCode']!, description: '' }]
        ...
        <div className='w-full py-4 max-w-[1440px] mx-auto'>
            <form className='w-full' onSubmit={handleProductAction}>
                            ...
                            <div className='panel-content'>
                                <div className=''>
                                        ...
                                        <div className='w-full'>
                                            <div className=''>
                                                <input placeholder='Mã sản phẩm' type='text' name='productCode' readOnly
                                                    value={typeof product?.productCode === 'object' ? (product?.productCode ?? '') : generateSecureRandomString(20)}
                                                    className='border-gray-300 p-2 border focus:border-blue-500 rounded-md w-full outline-none'
                                                />
                                            </div>
                                        </div>
                                    ...
                                    <div className='flex flex-col md:flex-row items-start md:items-center mb-5'>
                                        ...
                                        <div className='w-full'>
                                            <CategoryModalPicker category={typeof product?.category === "object" ? product.category : null} />
                                        </div>
                                    </div>
                                    {/* Description */}
                                    <div className='flex flex-col md:flex-row items-start md:items-center mb-5'>
                                            ...
                                            <div className=''>
                                                <select value={selectedBrand} onChange={(e) => setSelectedBrand(e.target.value)} className='border-gray-300 p-2 border rounded-md w-full outline-none' name='brand'>
                                                    {loadingBrands ?
                                                        ...
                                                        brands && brands?.data.map((brand: Brand) => {
                                                            return (
                ...
                <section className='overflow-hidden rounded-md bg-white mb-4 shadow-lg'>
                    <div className='p-2 md:p-6'>
                        <div className='panel-header'>
                            <div className='text-xl font-semibold mb-10'>Vận chuyển</div>
                        </div>
                        <div className='text-sm'>
                            <div className='panel-content'>
                                <div className=''>
                                    {/* Cân nặng */}
                                    <div className='flex flex-col md:flex-row items-start md:items-center mb-5'>
                                        <div className='flex-none mr-3 w-full md:w-36 text-start md:text-end'>
                                            <span className='text-red-500'>*</span>
                                            <span>Cân nặng (sau khi đóng gói)</span>
                                        </div>
                                        <div className='w-full'>
                                            <div className='border-gray-300 p-2 border focus:border-blue-500 rounded-md w-full flex  items-center'>
                                                <input placeholder='Nhập vào' type='number' name='weight' defaultValue={product?.weight ?? 0.5}
                                                    className='outline-none w-full'
                                                />
                                                <div className='h-5 w-[1px] bg-gray-300 mx-1.5'></div>
                                    ...
                                    <div className='flex flex-col md:flex-row items-start md:items-center mb-5'>
                                        ...
                                        <div className='w-full flex items-center flex-col gap-2 md:flex-row md:gap-0'>
                                            <div className='flex-auto w-full'>
                                                <div className='border-gray-300 p-2 border focus:border-blue-500 rounded-md w-full flex items-center'>
                                                    <input placeholder='Rộng' type='number' name='width' defaultValue={product?.width ?? 30}
                                                        className='outline-none w-full'
                                                    />
                                                    <div className='h-5 w-[1px] bg-gray-300 mx-1.5'></div>
                                            ...
                                            <HiOutlineXMark size={24} className='flex-none mx-1 hidden md:block text-gray-300' />
                                            <div className='flex-auto w-full'>
                                                <div className='border-gray-300 p-2 border focus:border-blue-500 rounded-md w-full flex items-center'>
                                                    <input placeholder='Dài' type='number' name='length' defaultValue={product?.length ?? 30}
                                                        className='outline-none w-full'
                                                    />
                                                    <div className='h-5 w-[1px] bg-gray-300 mx-1.5'></div>
                                                    <span className='text-gray-300'>cm</span>
                                            ...
                                            <div className='flex-auto w-full'>
                                                <div className='border-gray-300 p-2 border focus:border-blue-500 rounded-md w-full flex items-center'>
                                                    <input placeholder='Cao' type='number' name='height' defaultValue={product?.height ?? 30}
                                                        className='outline-none w-full'
                                                    />
                                                    <div className='h-5 w-[1px] bg-gray-300 mx-1.5'></div>
                                                    <span className='text-gray-300'>cm</span>
