...
const DashboardPage: React.FC = () => {
    ...
    const doughnutOptions: ChartOptions<"pie"> = {
        responsive: true,
        plugins: {
            legend: {
                ...
                <div className="w-full flex gap-4 flex-col md:flex-row">
                    <div className="w-full md:w-[70%]">
                        ...
                        <div className="w-full mt-4 bg-white rounded-xl px-3 py-6 shadow-md">
                            ...
                            <Line data={lineData} options={lineOptions} className="mt-4 w-fit" />
                        </div>
                    </div>
                    <div className="w-full h-fit md:w-[30%] bg-white rounded-xl px-3 py-6 shadow-md">
                        ...
                        <Pie data={doughtnutData} options={doughnutOptions} className="mt-4 w-fit" />
                    </div>
                </div>
