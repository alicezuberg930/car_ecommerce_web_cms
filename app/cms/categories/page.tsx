            ...
            <div className='py-5 px-2 md:px-6'>
                <div className='flex items-center justify-between mb-2 text-2xl font-semibold'>
                    ...
                    <div className='flex gap-2'>
                        <Link href={PATH.NEW_CATEGORY} className='flex items-center text-sm font-medium rounded-xl bg-blue-300 gap-1 text-white py-2 px-4'>
                            ...
                            <table className='min-w-full divide-y divide-gray-200'>
                                ...
                                <tbody className='bg-white divide-y divide-gray-200'>
                                    {isLoading ?
                                        ...
                                        <CategoryList setSelected={setSelectedCategory} categories={categories?.data.categories as Category[]} currentPage={currentPage} />
                                    }
                                </tbody>
                            </table>
                        </div>
                ...
                <div className='flex items-end justify-center min-h-screen px-4 py-6 text-center sm:block sm:p-0'>
                    ...
                    <div className='z-30 relative inline-block bg-white shadow-xl my-8 sm:align-middle max-w-5xl rounded-md w-full'>
                        <div className='px-4 py-5 bg-white text-left rounded-md'>
                            {selectedCategory ? <CategoryModal selectedCategory={selectedCategory} setSelected={setSelectedCategory} /> : <></>}
                        </div>
                    </div>
                </div>
            </div>
